...
<head>
<title>Avoindata.net - avoimen datan yhteisön kysymyksien tilastot</title>
...
<div id="header">
	<div class="container">
		<ul class="nav">
			...
			<li><a href="/dashboard/kysymykset/" class="current"><span>Kysymykset</span></a></li>
...
<!-- /.box -->
			...
			<div class="mainContent">
				<div class="article">
					<div class="details">
					<h2>Kysymysmäärät kategorioittain</h2>
					...
					<div style="clear:both; height:30px;"></div>
					<div class="details">	
					<h2>Eniten peukkuja</h2>
						
						<p><?php echo qa_most_votes_post(); ?></p>
					<h2>Eniten katseluita</h2>
						<p><?php echo qa_most_views_post(); ?></p>
					<h2>Eniten vastauksia</h2>
						<p><?php echo qa_most_answers_post(); ?></p>
					</div>

	...
	foreach ($item as $key => $value) {
		...
		if($key == 'timestamp') {
		  //Date.UTC(2013,3,12,0,0,0)
		  	array_push($dates,gmdate('Y,m-1,d,0,0,0', $value));
		}
	}
}
...
<html>
<head>
<title>Tampereen avoimen datan settien määrän kasvu</title>
...
$(function () {
        $('#line').highcharts({
            ...
            subtitle: {
                text: 'Tampereen avoimen datan settien määrän muutos/kasvu, jakso <?php echo $max; ?> päivää'
            },
            xAxis: {
                type: 'datetime'
            },

...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="/dashboard/vastaukset/"><b>Vastaukset</b><!--[if IE 7]><!--></a><!--<![endif]-->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div style="width:430px;float:left;margin-right:0px;padding-left:0px;margin-left:2px;">
				<h2 class="boxtitle" style="margin:0px;width:100%;padding-right:7px;">Statistiikkaa vastauksista</h2>
				...
				<div class="stats">
					<div class="label">Vastauksia:</div> 
					<div id="count"><?php echo qa_answer_count(); ?></div>
				</div>
				<div class="stats">
			...
			<div style="width:900px;float:left;margin-right:0px;padding-left:0px;margin-top:30px;">
				<h2 class="boxtitle" style="margin-right:4px;margin-left:4px;">Vastausmäärät <a href="/dashboard/kategoriat/">kategorioittain</a> | <span style="font-size:14px;"><a href="#" onclick="return false;" class="show_hide">Näytä yksityiskohdat</a></span>
				<span style="font-size:14px;float:right;">Katso myös <a href="/dashboard/kysymykset/">kysymyksien tilastot</a></span>
				</h2>
			...
			<div class="fancytable" >
				...
				<tbody>
					<?php echo qa_answercount_categories_table();?>	
				</tbody>
				</table>
            		</div>
			</div> 
